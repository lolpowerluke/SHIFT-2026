    ...
    },
    {
        ...
        answer: (
            <>
                ...
                .<br/>
                Inschrijven is niet verplicht om dit evenement bij te wonen, maar wel sterk aangeraden.
            </>
        ),
    },
    {
                                ...
                                >
                                    <div className={`${s.flexRow} ${s.howto}`}>
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Metro 6/2 naar Delacroix of bus N46/T81 tot Albert I, daarna te voet
                                                naar de campus (5 tot 10 min).
                                            </p>
                                        </div>
                                    </div>
                                    <div className={`${s.flexRow} ${s.howto}`}>
