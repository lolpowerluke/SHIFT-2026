...
const faq = [
	...
	},
	{
		...
		answer: (
			<> SHIFT is bedoeld voor toekomstige studenten die een studiekeuze willen maken,
            alumni, bedrijven en ouders, familie en vrienden van de derdejaarsstudenten.</>
		),
	},
	{
						...
						<div className={`${s.infoCard}`}>
							...
							<div className={`${s.flexRow}`}>
								...
								<div>
									...
									<p>
										Metro 5 tot Aumale of tram 81 tot Conscience.
										<br />
										Beide op 8 minuten wandelen.
									</p>
								</div>
							</div>
							<div className={`${s.flexRow}`}>
							...
							<div className={`${s.flexRow} ${s.traffic}`}>
								...
								<div>
									<h4>MET DE AUTO</h4>
									<p>
										Beperkt parkeren op de campus. Gratis bezoekersparking in de
										buurt.
									</p>
								</div>
							</div>
