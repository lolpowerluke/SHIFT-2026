            ...
            <div className={`ctx ${s.voorproefje}`}>
                ...
                <div className={s.videoHolder}>
                        <div className={s.videoWrapper}>
                            <iframe control src="https://ehb-my.sharepoint.com/personal/yarno_vandenplas_student_ehb_be/_layouts/15/embed.aspx?UniqueId=32110fa6-e65a-4684-aa2d-1e43f00d9a79&embed=%7B%22ust%22%3Atrue%2C%22hv%22%3A%22CopyEmbedCode%22%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create" width="853" height="480" frameborder="0" scrolling="no" allowfullscreen title="SuperCut_Done.mp4"></iframe>
                        </div>
                </div>
            </div>
        </>
