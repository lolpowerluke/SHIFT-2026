        ...
        <>
            <div className="heroContent">
                <video autoPlay muted loop playsInline>
                    <source src="/assets/heroContent/videohero_test.webm" type="video/webm"/>
                ...
                <div className="copy-text section darkText" id="copy-text">
                    <div className="shiftCopy cardDiv">
                        ...
                        <p>
                            ...
                            en de opleiding{" "}
                            <a href="https://www.erasmushogeschool.be/nl/opleidingen/multimedia-en-creatieve-technologie">
                        ...
                        <br/>
                        <p>
                            Kom de indrukwekkende eindprojecten van de derdejaars bewonderen
                            en breng je stem uit op je favoriete projecten, zodat ze tijdens
                            de awardshow een prijs kunnen winnen.
                        </p>
                    </div>
                    <div className="mctCopy cardDiv">
                        ...
                        <p>
                            ...
                            <br/>
                            <br/>
                            Deze opleiding combineert creativiteit met techniek, gericht op
                            het ontwikkelen van digitale ervaringen, interactieve
                ...
                <div>
                    <div>
                        <p className="xlarge bold">
                            Wil je er zeker bij zijn?
                            <br/>
                            Plaats het nu al in je agenda!
                        </p>
                    </div>
                    <br/>
                    <a
