				...
				<div className={`${s.landingBottom} ${s.mobile}`}>
					<div>
						<a
							...
							target="_blank"
						>
							Bezoek het evenement
						</a>
						<span>
							Vier categorieën die excellentie erkennen in innovatie, impact en
							creativiteit.
						</span>
					</div>
					<div>
						<Link className="linkBtn" to={Routes.Project}>
							Ontdek alle projecten
						</Link>
				...
				<div className={s.awardBottom}>
					<div className={s.awardCard}>
						...
						<span className={s.cardDesc}>
							Deze gaat naar het project dat de grootste maatschapelijke impact
							maakt en het meest potentieel maakt om echte veranderingen te
							maken in de wereld.
						</span>
					</div>
					<div className={s.awardCard}>
					...
					<div className={s.awardCard}>
						...
						<span className={s.cardDesc}>
							De juryprijs wordt uitgereikt door onze eigen docenten met hun
							jaren ervaring en kennis.
						</span>
					</div>
				</div>
				<div className={s.awardTop}>
